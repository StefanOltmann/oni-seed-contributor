...
project.afterEvaluate {
    ...
    outputDir.resolve("AppApiKeys.kt").printWriter().use { writer ->
        ...
        val apiKey = System.getenv("MNI_API_KEY_DOCKER")

        if (apiKey == null || apiKey.isBlank())
            error("MNI_API_KEY_DOCKER environment variable is not set")

        writer.println("const val MNI_API_KEY_DOCKER: String = \"$apiKey\"")
